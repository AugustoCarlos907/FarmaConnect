  ...
  <div class="container-xl">
    <div class="d-flex align-items-center gap-3">
      ...
      <div class="header-search d-none d-md-block mx-auto">
        <form action="{{ route('produtos.clientes') }}" method="GET" class="ig">
          <span class="ig-icon"><i class="bi bi-search"></i></span>
          <input type="text" name="query" value="{{ request('query') }}" placeholder="Pesquise categorias...">
          <button type="submit" class="ig-btn"><i class="bi bi-arrow-right-circle-fill"></i></button>
        </form>
      </div>
  ...
  <div class="container-xl">
    ...
    @else
      ...
      <div class="cat-grid" id="catGrid">
        ...
        {{-- <a class="cat-card" href="#" title="Analgésicos e Antitérmicos">
          <div class="cc-img">
            <img src="https://images.unsplash.com/photo-1584308666744-24d5c474f2ae?w=400&auto=format&fit=crop"
                 alt="Analgésicos e Antitérmicos" loading="lazy">
            <div class="cc-img-overlay"></div>
            <div class="cc-arrow"><i class="bi bi-arrow-right"></i></div>
          </div>
          <div class="cc-body">
            <div class="cc-name">Analgésicos e Antitérmicos</div>
            <div class="cc-desc">Alívio da dor e febre</div>
            <div class="cc-footer">
              <span class="cc-count"><i class="bi bi-capsule-pill" style="font-size:.7rem;"></i> 218 medicamentos</span>
            </div>
          </div>
        </a>
             @foreach  --}}
      ...
      <!-- Paginação (activar quando o controller usar paginate()) -->
